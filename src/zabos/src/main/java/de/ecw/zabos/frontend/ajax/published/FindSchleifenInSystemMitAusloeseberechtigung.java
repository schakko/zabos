...
/**
 * Liefert die Schleifen einer Organisation zurueck<br>
 * 
 * <table border="1">
 * <tr>
 ...
 * @return JSON-Objekt
 */
public class FindSchleifenInSystemMitAusloeseberechtigung extends
                AbstractAjaxMethodAdapter
{
    private final static Logger log = Logger
                    .getLogger(FindSchleifenInSystemMitAusloeseberechtigung.class);

    public FindSchleifenInSystemMitAusloeseberechtigung(final DBResource db)
    {
        super(db);
    }
